...
async def direct_join_team(teamcode, max_retries=3, timeout=5):
    ...
    try:
        from BLACK_Apis import online_writer, key, iv, team_collection_active
...
async def direct_send_emote(uid, emote_code, max_retries=2):
    ...
    try:
        from BLACK_Apis import online_writer, key, iv, region, team_collection_active
...
async def direct_leave_team():
    ...
    try:
        from BLACK_Apis import online_writer, key, iv
...
def web_panel():
    ...
    <head>
        ...
        <title>🎮 EMOTE WEB - Gaming Emote Panel</title>
        ...
        <div class="dashboard">
            ...
            <div class="header">
                <div class="logo">
                    ...
                    <div class="logo-text">EMOTE WEB</div>
                </div>
                ...
                <div class="left-column">
                    ...
                    <div class="panel">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="input-field" id="uid" placeholder="Enter player UID (e.g., 11686472351)">
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="input-field" id="emoteId" placeholder="Enter emote ID (e.g., 909000001)">
                        </div>
                        
                        <button class="btn" onclick="sendManualEmote()">
                            <i class="fas fa-paper-plane"></i> SEND EMOTE NOW
                        </button>
            ...
            function renderEmotes() {
                ...
                displayedEmotes.forEach(emote => {
                    ...
                    const sourceBadge = emote.source === 'local' 
                        ? '<div class="emote-source-badge source-local">BLACK_Apis</div>'
...
def api_debug_status():
    ...
    try:
        from BLACK_Apis import team_collection_active, team_members_data, online_writer
...
def start_flask():
    ...
    print("""
╔══════════════════════════════════════════════╗
║       🎮 EMOTE WEB - Gaming Emote Panel      ║
╚══════════════════════════════════════════════╝

🌐 Web Panel: https://emote-web-putri.vercel.app/
📡 API: https://emote-web-putri.vercel.app/emote?uid=...&emote_id=...&teamcode=...

📁 LOCAL EMOTE PATH: /storage/emulated/0/html/emote/api/emote_pngs/
🌐 WEB ENDPOINT: /local-emotes/{emote_id}.png

⚡ FEATURES:
   • Modern, responsive UI with no login required
   • 433 hardcoded emotes (no file dependency)
   • Loads PNGs from local storage first, CDN as fallback
   • Normal & Persistent modes
   • Click debouncing and visual feedback
   • Emote search and filtering
   • Source indicators (Local/CDN)
   • Quick actions
   • Real-time status indicators

📸 Emote images from: Local storage with CDN fallback
    """)
...
if __name__ == '__main__':
    ...
    try:
        print("[EMOTE WEB] Starting bot...")
        from BLACK_Apis import StarTinG
